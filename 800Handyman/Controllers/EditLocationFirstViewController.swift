//
//  EditLocationFirstViewController.swift
//  800Handyman
//
//  Created by Creativeitem on 31/7/18.
...
class EditLocationFirstViewController: UIViewController{
    ...
    @objc func handleNextButton() {
        ...
        let serviceDetailsListVC = ServiceDetailsListViewController()
...
extension EditLocationFirstViewController: UIScrollViewDelegate {
    
}

extension EditLocationFirstViewController: CLLocationManagerDelegate {
...
extension EditLocationFirstViewController : GMSMapViewDelegate {
...
// API Functions
extension EditLocationFirstViewController {
...
extension EditLocationFirstViewController : UITextFieldDelegate {
